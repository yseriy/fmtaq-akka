...
import ys.fmtaq.prototype.connector.RabbitConnector;
import ys.fmtaq.prototype.connector.RunMsg;

public class FmtaqAkka {

    public static void main(final String[] args) {
        ActorSystem actorSystem = ActorSystem.create("rabbit_connector");
        ActorRef rabbitConnector = actorSystem.actorOf(Props.create(RabbitConnector.class), "connector");
        rabbitConnector.tell(new RunMsg(), ActorRef.noSender());
//        rabbitConnector.tell(new RunMsg(), ActorRef.noSender());
//        Thread.sleep(5000);
//        rabbitConnector.tell(new StopMsg(), ActorRef.noSender());
